...
Nine of the tools do not run on Telethon: the secret-chat tools, because Telethon never
implemented MTProto 2.0. Those nine run on TDLib, which keeps its **own** authorisation
and cannot read or import a Telethon session.
